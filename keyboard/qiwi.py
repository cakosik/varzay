...
apanel.add(types.InlineKeyboardButton(text='📢', callback_data='rass'))
srez2 = types.InlineKeyboardMarkup(row_width=3)
srez2.add(types.InlineKeyboardButton(text='✂️', callback_data='srez'))
men=types.InlineKeyboardMarkup(row_width=3)
men.add(types.InlineKeyboardButton(text='📢', callback_data='rass'))
men.add(types.InlineKeyboardButton(text='✂️', callback_data='srez'))
men.add(types.InlineKeyboardButton(text='🏧', callback_data='wdzy'))
men.add(types.InlineKeyboardButton(text='🎁', callback_data='razdacha'))

razda = InlineKeyboardMarkup(row_width=1)
razdacha=InlineKeyboardButton(text='🎁', callback_data='razdacha')
...
donat8 = InlineKeyboardButton(text='💥 ', callback_data='donat8')
...
help_donat2.add(donat1, donat2, donat3, donat4, donat8,donat6,donat7)
def uchas(count):
