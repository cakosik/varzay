...
help_donat.add(donat1, donat2, donat3, donat4, donat8,donat6,donat7)
...
help_bonus.add(bonus , main1) #что бы убрать бонус с баланса надо help_bonus.add() написать вот так
...
grag_bonus = InlineKeyboardButton(text='💥 DRAGON Бoнус ', callback_data='bonus4')
help_bonus2.add(simple_bonus,vip_bonus,prem_bonus,grag_bonus)
